    ...
    extend: {
      ...
      keyframes: {
        ...
        "hologram-pulse": {
          "0%, 100%": {
            opacity: "1",
            boxShadow: "0 0 20px hsl(195 100% 50% / 0.3), 0 0 40px hsl(195 100% 50% / 0.2)",
          },
          "50%": {
            opacity: "0.9",
            boxShadow: "0 0 40px hsl(195 100% 50% / 0.5), 0 0 80px hsl(195 100% 50% / 0.3)",
          },
        },
        "neon-flicker": {
          "0%, 100%": { opacity: "1" },
      ...
      animation: {
        ...
        "glide-in": "glide-in 0.8s cubic-bezier(0.16, 1, 0.3, 1)",
        "hologram-pulse": "hologram-pulse 3s ease-in-out infinite",
        "neon-flicker": "neon-flicker 0.1s ease-in-out",
